provider "azurerm" {
  features {}
  subscription_id = "59f028ec-d9e0-440d-abfe-64468f11dee3"
  tenant_id = "899789dc-202f-44b4-8472-a6d40f9eb440"
  client_id = "08f06cf2-1681-41b6-9575-bf0a5306318a"
  client_secret = "smy8Q~XyOZj-2lcsOA~-PJZHsMERUwezvaYl5chk"
}
